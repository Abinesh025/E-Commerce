    ...
    <div>
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-3 border-b border-gray-300 bg-white relative transition-all">
            ...
            <a href="https://prebuiltui.com">
               <svg width="200" height="50" viewBox="0 0 900 300" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        d="M200 190 C350 260, 550 260, 700 200"
                        fill="none"
                        stroke="#FF9900"
                        stroke-width="17"
            ...
            {/* Desktop Menu */}
            <div className="hidden sm:flex items-center gap-8 w-[75%]">
                <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-lg w-full">
                    <input className="py-1.5 px-[30px] w-full bg-transparent outline-none placeholder-gray-500" type="text" placeholder="Search products " />
